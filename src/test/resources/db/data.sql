INSERT INTO `user`(`id`, `name`, `email`, `phone_number`, `password`, `status`, `last_login_time`) VALUES (1, 'json',
'json@json119.com', '13888888888', 'json', 1, NOW());
INSERT INTO `user`(`id`, `name`, `email`, `phone_number`, `password`, `status`, `last_login_time`) VALUES (2, 'admin',
'admin@json119.com', '13999999999', '55b3d0936a3fb63168d57a6bda0ddbbf', 1, NOW());
